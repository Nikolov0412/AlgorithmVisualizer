...
import './home.css'
import { Layout,Carousel,Typography,Card, Col, Row,Space } from "antd";
...
function Home(){
  ...
  <Carousel autoplay>
    ...
    <img src={carouselImage} style={{height:'700px',width:'100%'}}/>
...
<div className="site-card-wrapper" >
  <Row gutter={16}>
      <Col span={8}>
        <Card title="Pathfinding" bordered={false}>
        <img src={pathfinding} style={{height:'300px',marginLeft:'20%'}} />
        <div className="Text">
      ...
      <Col span={8}>
        <Card title="Sorting" bordered={false}>
        <img src={bubbleSort} style={{height:'300px',marginLeft:'20%'}} />
        <div className="Text">
      ...
      <Col span={8}>
        ...
        <img src={graphs} style={{height:'300px'}} />
            <div className="Text">
